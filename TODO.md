...
- [~] 🔴 **Net-connectivity (visual-first).** _Aggiornato 2026-06-20 con misure su F1 GT (arduino_micro/nano)._
  ...
  - **2° leva indipendente:** ref-recovery. **nano è bloccato senza OCR:** il PDF nano ha `texts=0` (testo outlined/vettorizzato, nessun layer testo) → `refs=0`, overlap 3/34. Non recuperabile senza OCR (vietato). Solo micro è bersaglio viable.
